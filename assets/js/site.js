...
(function () {
  ...
  var COMMANDS = [
    ...
    { title: "Speed reading (RSVP)", desc: "Rapid serial visual presentation · 6 passages · WPM + comprehension check", icon: "play", url: "/practice/#rsvp", group: "Drills", keywords: "rsvp speed reading wpm comprehension fast eye chunk fixation ce" },
    { title: "Voice recorder (EO)", desc: "Record your monologue, listen back · local-only, never uploaded", icon: "play", url: "/practice/#voicerec", group: "Drills", keywords: "voice recording eo speaking expression orale mic monologue" },
